...
> = {
  "match-1": 0.99, // Локомотив
  "match-2": 0.76, // Спартак
  "match-3": 0.98, // Авангард
  "match-5": 0.75, // Амур
  "match-7": 0.82, // Сибирь
  "match-8": 0.89, // Ак Барс
  "match-10": 0.72, // ЦСКА
  "match-17": 0.97, // Металлург
  "match-19": 0.95, // Динамо Минск
  "match-20": 0.69, // Салават Юлаев
  "match-28": 0.7, // ХК Сочи
  "match-33": 0.61, // Торпедо
};
